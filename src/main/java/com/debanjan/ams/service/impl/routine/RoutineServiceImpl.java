package com.pabitra.ams.service.impl.routine;


import com.pabitra.ams.entity.routine.Routine;
import com.pabitra.ams.repository.CurrentSemRepo;
import com.pabitra.ams.repository.routine.RoutineRepo;
...
import com.pabitra.ams.service.routine.RoutineService;
...
public class RoutineServiceImpl implements RoutineService {
    ...
    private List<RoutineSubject> getPrimaryTeacherSubjects(String day, String teacherId, List<String> batches,
        ...
        System.out.println(day+" " +teacherId+" "+ batches.get(0)+" "+
                semesters.get(0)+" " + batches.get(1)+" "+ semesters.get(1)+" "+batches.get(2)+" "+ semesters.get(2)+" "+ batches.get(3)+" "+ semesters.get(3));
    ...
    public TeacherSubjectResponse getTeacherWiseAllSubjectByDay(String day, String teacherId) {
        ...
        System.out.println(batches+" "+semesters);
